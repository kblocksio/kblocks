...
export const ENGINES: Record<string, Engine> = {
  ...
  tofu:            { id: "tofu",           description: "Block is implemented through an OpenTofu configuration." },
  terraform:       { id: "terraform",      description: "Block is implemented through a Terraform configuration." },
